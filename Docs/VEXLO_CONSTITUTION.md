...
The business target is at least `$75K/month` in sustainable revenue. Every meaningful product decision should support at least one of these outcomes without cheapening the game:
...
That higher ambition does not justify cheapening the product, copying competitors, or abandoning masterpiece architecture.
...
- copycat product direction

Vexlo must not become a copy of successful hexa puzzle competitors.

Its differentiating thesis is:
- board reading
- calm intensity
- ritual mastery

The product should evolve from a placement puzzle toward a reading puzzle.

Players should increasingly feel they are reading:
- board pressure
- future clear potential
- quality of move, not just move legality
...
- no flashy full-3D spectacle
- no arcade-style combo fireworks
- no social-spam share-card drift

Subtle semantic board lighting and board response may become signature premium surfaces if handled with restraint.

Mode distinctions:
- normal mode should remain more evergreen, quieter, and more purely Vexlo
- daily mode should carry the ritual layer
- daily should increasingly feel like a real ritual with subtle day-character, not just a separate mode
...
A future run identity or playstyle layer may be a strong differentiator only if it remains calm, editorial, premium, and non-spammy.
...
Good, very good, and expert play should become more visible through meaning and product response, not loudness or cheap spectacle.
...
- no fake urgency
- no manipulative retention tricks
...
Revenue visibility matters because the `$75K/month` target is real. But revenue must never be pursued in ways that damage product dignity.
...
These directions must be pursued step by step, in order, without forgetting them, and only in ways that preserve constitution-level architecture, premium restraint, and ethical neuromarketing.
