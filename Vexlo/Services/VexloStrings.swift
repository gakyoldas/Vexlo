...
enum VexloStrings {
    ...
    enum Overlay {
        ...
        static let savedForNextRun = localized("overlay.saved_for_next_run", value: "Saved for the next run")
        static let oneCleanerRun = localized("overlay.one_cleaner_run", value: "One cleaner run does it")
